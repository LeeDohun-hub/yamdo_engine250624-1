...
void Animator::CreateAnimation(const std::wstring &name,
                               graphics::Texture *spriteSheet, Vector2 leftTop,
                               Vector2 size, Vector2 offset, UINT spriteLegth,
                               float duration) {
  ...
  animation->CreateAnimation(name, spriteSheet, leftTop, size, offset,
...
void Animator::CreateAnimationByFolder(const std::wstring &name,
                                       const std::wstring &path, Vector2 offset,
                                       float duration) {
  Animation *animation = nullptr;
  animation = FindAnimation(name);
  if (animation != nullptr)
    return;
  // C:\Users\WORK\Desktop\Gamecoding\yamdo_engine\Resources\Mushroom
  // C:\Users\WORK\Desktop\Coding\yamdo_engine250618 -
  // master\Resources\Mushroom
  int fileCount = 0;
  ...
  CreateAnimation(name, spriteSheet, Vector2(0.0f, 0.0f),
                  Vector2(imageWidth, imageHeight), offset, fileCount,
                  duration);
}
